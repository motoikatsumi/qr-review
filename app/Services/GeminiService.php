...
- 口コミ内容が空（星評価のみ）の場合は、ご来店と評価への感謝を丁寧に述べ、取扱商品の紹介を含める。「どのようなお品物かは存じませんが」のような知らないことを示す表現は絶対に使わない。「温かいお言葉」「嬉しいコメント」など口コミ文章があるかのような表現も使わない（コメントが無いため）。口コミが空の場合はご来店・ご利用・評価への感謝のみにとどめる
